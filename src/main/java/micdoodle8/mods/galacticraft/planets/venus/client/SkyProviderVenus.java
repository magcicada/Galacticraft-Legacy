...
public class SkyProviderVenus extends IRenderHandler
{
    ...
    public void render(float partialTicks, WorldClient world, Minecraft mc)
    {
        ...
        OpenGlHelper.glBlendFunc(GlStateManager.SourceFactor.SRC_ALPHA.factor, GlStateManager.DestFactor.ONE.factor, GlStateManager.SourceFactor.ONE.factor, GlStateManager.DestFactor.ZERO.factor);
        GlStateManager.pushMatrix();
        f7 = 0.0F;
        f8 = 0.0F;
        f9 = 0.0F;
